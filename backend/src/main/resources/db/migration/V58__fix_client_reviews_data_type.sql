-- V58: Fix get_client_reviews_given - correct data type for CONCAT result
...
BEGIN
    ...
    SELECT 
        ...
        CONCAT(freelancer_profile.first_name, ' ', freelancer_profile.last_name)::TEXT AS freelancer_name,
        r.rating,
        r.comment,
        c.created_at
    FROM reviews r
